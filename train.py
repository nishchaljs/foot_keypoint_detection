...
def train(prepared_train_labels, train_images_folder, num_refinement_stages, base_lr, batch_size, batches_per_iter,
    ...
    net = PoseEstimationWithMobileNet(num_refinement_stages,num_heatmaps=25, num_pafs=50)
...
if __name__ == '__main__':
    ...
    parser.add_argument('--base-lr', type=float, default=4e-4, help='initial learning rate')
